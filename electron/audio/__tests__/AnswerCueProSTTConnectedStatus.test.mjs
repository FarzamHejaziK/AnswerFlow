...
test('AnswerCueProSTT connected event clears reconnecting status back to awaiting audio without waiting for a final transcript', () => {
...
test('AnswerCueProSTT connected event resets consecutive errors for later failures', () => {
  const stt = new EventEmitter();
  const statuses = [];
  wireConnectedStatus(stt, (status) => statuses.push(status));

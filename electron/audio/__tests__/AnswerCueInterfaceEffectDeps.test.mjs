// Regression test for: AnswerCueInterface.tsx mega-effect dep array must be []
//
// Bug: The large useEffect at ~L1434 in src/components/AnswerCueInterface.tsx
...
//
// Strategy: source-level static check on AnswerCueInterface.tsx. Rendering

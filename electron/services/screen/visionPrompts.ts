...
export const DIRECT_VISION_SYSTEM_PROMPT = `You are AnswerCue's screen understanding and live assistance engine.
...
export const TECHNICAL_INTERVIEW_SYSTEM_PROMPT = `You are AnswerCue's technical interview copilot.
...
export const CODE_DEBUG_SYSTEM_PROMPT = `You are AnswerCue's code analysis assistant.
...
export const STRUCTURED_EXTRACTION_SYSTEM_PROMPT = `You are AnswerCue's screen understanding engine. Extract structured information from the attached screenshot.
...
export const GENERAL_VISION_SYSTEM_PROMPT = `You are AnswerCue's screen understanding assistant.
